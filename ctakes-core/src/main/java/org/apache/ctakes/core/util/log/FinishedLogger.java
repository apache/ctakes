...
final public class FinishedLogger extends JCasAnnotator_ImplBase {
   ...
   /**
    * Increase the count of documents being processed.
    * {@inheritDoc}
    */
   @Override
   ...
   /**
    * Logs basic information on the run, such as total run time and time per document.
    * {@inheritDoc}
   ...
   /**
    * @param millis milliseconds for a time and date since January 1, 1970.
    * @return formatted text for the time and date.
    */
   ...
   /**
    * @param millis milliseconds of a span of time, for instance milliseconds in an hour.
    * @return formatted text in days, hours, minutes, and seconds.
    */
   ...
   /**
    * Get cTAKES build information.  This only works for a cTAKES binary installation jars, not simply compiled code.
    * Example:
    * Build Version: 4.0.1-SNAPSHOT
    * Build Date: 2022-10-26 15:59
    * @param attributeNames formatted jar constants for version, build date, etc.
    * @return build information for the running cTAKES version or an empty map if none is found.
    */
   ...
   /**
    * @param attributes all attributes in a jar manifest.
    * @param attributeName name of the wanted attribute.
    * @return text value of the wanted attribute, or empty text if the attribute is not found.
    */
